...
while True: 
    ...
    time.sleep(0.4) #for the solely porpuse of no overcharging the computer
  
    #to check the weather the status is changing
    #print(status, "\n")
...
df.to_csv(".venv\ImageProcessing\VideoCapture\Object detection timestamp.csv")
